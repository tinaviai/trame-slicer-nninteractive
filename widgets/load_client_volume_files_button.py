...
class LoadClientVolumeFilesButton(Div):
    def __init__(self, server: Server, slicer_app: SlicerApp, set_prompt_manager_fn):
        super().__init__()
        self._slicer_app = slicer_app
        self.set_prompt_manager_fn = set_prompt_manager_fn
    ...
    def _on_load_client_files(self, files: list[dict]) -> None:
        ...
        with TemporaryDirectory() as tmp_dir:
            ...
            self.set_prompt_manager_fn(volume_node)
